...
class FriendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friend" do
    assert_difference('Friend.count') do
      post friends_url, params: { friend: { comment: @friend.comment, email: @friend.email, name: @friend.name } }
    end
  ...
  test "should update friend" do
    patch friend_url(@friend), params: { friend: { comment: @friend.comment, email: @friend.email, name: @friend.name } }
